...
namespace MazeManiac
{
    ...
    class Dragon : Enemy
    {
        public Dragon()
        {
            ...
            this.agility = 3;
            this.endurance = 7;
            this.weapon = new Weapon(10, "éles fog");
            this.damage = this.calculateDmg(this.weapon, this.strength);
        }
    }
    class RetardedLeopardSeal : Enemy
    {
        public RetardedLeopardSeal()
        {
            this.name = "RetardedLeopardSeal";
            this.hp = 5;
            this.lvl = 1;
            this.strength = 1;
            this.agility = 1;
            this.endurance = 1;
            this.weapon = new Weapon(1, "tompa fogak");
            this.damage = this.calculateDmg(this.weapon, this.strength);
        }
    }
}
